...
" Evaluate expression
let g:WhichKeyDesc_Major_Debug_Debug = "<leader>de  evaluate"
nnoremap <leader>de    :action EvaluateExpression<CR>
vnoremap <leader>de    <Esc>:action EvaluateExpression<CR>

" Kill (Stop application)
let g:WhichKeyDesc_Debug_Kill = "<leader>dk kill"
